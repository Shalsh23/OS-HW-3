...
__device__ void initHashTable(MyHashMapElement *hme, int tablerange, int subrange, int strlength);
__device__ bool insertElement(MyHashMapElement *hme, unsigned long key, int keyshift, int bucketsize, int initValue);
